...
def get_args():
    ...
    parser.add_argument('-u', '--username', help='Username', default='potamaxxx')
    parser.add_argument('-p', '--password', help='Password', default='themagicword')
    parser.add_argument('-l', '--location', type=parse_unicode, help='Location, can be an address or coordinates', default='jalan puncak mandala malang')
    parser.add_argument('-st', '--step-limit', help='Steps', default='15', type=int)
    ...
    parser.add_argument('-t', '--threads', help='Number of search threads', required=False, type=int, default=10, dest='num_threads')
